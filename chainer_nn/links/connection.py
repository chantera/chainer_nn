...
from chainer_nn.functions.connection import embed_id
...
class EmbedList(chainer.link.ChainList):
    ...
    def __init__(self, embeddings, dropout=0.0, merge=True, split=True):
